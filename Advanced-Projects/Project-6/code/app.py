...
# ---------------- Load Model ----------------
MODEL_PATH = "C:/Users/Dell/Downloads/ML-Capstone-Projects/Advanced-Projects/Project-6/code/model.pkl"
VECTORIZER_PATH = "C:/Users/Dell/Downloads/ML-Capstone-Projects/Advanced-Projects/Project-6/code/vectorizer.pkl"
    ...
    if st.button("Predict"):
        if user_input.strip() == "":
            ...
            if os.path.exists(DATASET_PATH):
                try:
                    data_df = pd.read_csv(DATASET_PATH, encoding='latin-1', usecols=[0,1], names=['label','v2'], on_bad_lines='skip')
